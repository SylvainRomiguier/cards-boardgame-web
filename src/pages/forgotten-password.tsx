...
export const ForgotPassword: NextPage<{variant?: "regular" | "small"}> = ({ variant = "regular"}) => {
                ...
                onSubmit={async (values, { setErrors }) => {
                  ...
                  if (!response.data?.forgotPassword) {
                    ...
                    toast({
                        ...
                        description: "An email with a link to reset your password has been sent. The link will be valid for 10 minutes.",
                        status: "success",
                        isClosable: true
                      });
                  }
